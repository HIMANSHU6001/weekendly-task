        ...
        >
          <svg className="mr-2 h-4 w-4" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google"
            ...
            <path fill="currentColor"
                  d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 126 23.4 172.9 61.9l-76.2 64.5c-20.3-19.1-49.4-30.6-82-30.6-62.5 0-113.5 51.6-113.5 115.3s51 115.3 113.5 115.3c71.2 0 98.2-53.2 102.7-77.9H248V261.8h239.2z"></path>
          </svg>
          Sign in with Google
        </Button>
      </div>
